...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.img_add = tk.PhotoImage(file="C:\\Users\\ludmi\\OneDrive\\Документы\\new\\prpr\\add.png")
        ...
        self.img_upd = tk.PhotoImage(file="C:\\Users\\ludmi\\OneDrive\\Документы\\new\\prpr\\change.png")
        ...
        # Кнопка поиска
        self.img_search = tk.PhotoImage(file="C:\\Users\\ludmi\\OneDrive\\Документы\\new\\prpr\\search.png")
        ...
        # Кнопка обновления
        self.img_refresh = tk.PhotoImage(file="C:\\Users\\ludmi\\OneDrive\\Документы\\new\\prpr\\refresh.png")
